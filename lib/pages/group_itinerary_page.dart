...
class _GroupItineraryPageState extends State<GroupItineraryPage> {
  ...
  String _generateDelightMoment(String destination, String phase) {
    switch (phase) {
      case 'start':
        return 'Analyzing group preferences for $destination...';
      case 'data':
        return 'Gathering insights for group-friendly activities...';
      case 'thinking':
        return 'Finding perfect spots for group experiences...';
      case 'results':
        return 'Creating collaborative recommendations...';
      default:
        return 'Planning the perfect group adventure for $destination...';
    }
  }
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Create perfect itineraries for your group travels',
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'Perfect for families, friends, and travel groups',
                                  ...
                                  Row(
                                    children: [
                                      Expanded(
                                        ...
                                        ).animate().fadeIn(delay: 400.ms, duration: 200.ms).slideY(begin: 0.2),
                                      ),
                                      const SizedBox(width: 12),
                                      Container(
                                        width: 48,
                                      ...
                                      ).animate().fadeIn(delay: 450.ms, duration: 200.ms).scale(begin: const Offset(0.8, 0.8)),
                                    ],
                                  ),
                                ],
                              ),
